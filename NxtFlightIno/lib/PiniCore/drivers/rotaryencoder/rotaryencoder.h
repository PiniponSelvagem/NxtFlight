...
#ifndef _PINICORE_ROTARYENCODER_H_
#define _PINICORE_ROTARYENCODER_H_
...
private:
    ...
    int32_t             _delta;             // rotation delta since last getDelta call
};



#endif /* _PINICORE_ROTARYENCODER_H_ */
